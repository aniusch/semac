    ...
    return (
        <div className='hero-terceira' id='hero-terceira'>
            <nav className='nav-bar-terceira'>
                <a href={'/'} target='_blank' className='botao-para-home'> <img alt='SEMAC Logo' src={logo} /> </a>
            ...
            <section className='conteudo-hero-terceira'>
                ...
                <h1 className='heading-hero'>III Semana das Engenharias de Automoção e Computação</h1>
                <p className='paragrafo-hero'>Explore as últimas tendências em automação e computação com especialistas, workshops práticos e oportunidades
                    de networking. Garanta sua vaga e esteja à frente das inovações tecnológicas!
                </p>
